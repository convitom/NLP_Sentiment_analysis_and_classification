"""
src/train.py
Training script for SemEval 2018 Task 1 Multi-Label Emotion Classification.

Features:
  - Fine-tunes any of 4 encoder-only backbones: bert | roberta | deberta | electra
  - Multi-label: bce | bce_weighted | focal_bce | asymmetric loss
